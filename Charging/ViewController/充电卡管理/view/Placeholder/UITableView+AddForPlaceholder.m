...
- (void)layoutDefaultView:(UIView *)defaultView {
    ...
    UIImage *image = self.defaultNoDataImage ? : [UIImage imageNamed:@"chargeCard_placeholder"];
...
- (UIImageView *)defaultNoDataNoticeImageView {
    ...
    if (!imageView) {
        ...
        imageView.image = self.defaultNoDataImage ? : [UIImage imageNamed:@"chargeCard_placeholder"];
